  ...
  experience: [
    {
      ...
      period: '2023 - Present',
      description: 'Leading development of enterprise web applications using Next.js and Node.js.',
      highlights: [
    ...
    },
    {
      ...
      period: '2021 - 2023',
      description: 'Developed and maintained multiple client projects across various industries.',
      highlights: [
    ...
    },
    {
      ...
      company: 'StartUp Hub',
      period: '2019 - 2021',
      description: 'Created responsive web applications and contributed to design systems.',
      highlights: [
